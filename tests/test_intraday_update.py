...
def test_seasonal_shadow_morning_keeps_intraday_weak_when_nwp_still_heats(tmp_path):
    training = _training_frame(issue_hour=6, month=5, future_increase=7.0, observed_max=18, last_temp=15)
    timing = _timing_frame(month=5, tmax_hour=15)
    base = TmaxDistribution([18, 22, 25, 26], [0.05, 0.2, 0.5, 0.25])
